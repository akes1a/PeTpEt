...
- 系统托盘菜单可显示或隐藏宠物、打开待办事项、每日论文、流程画板、GPT、DeepSeek 和控制面板，以及设置开机自启和退出程序。
- 单击托盘图标可快速切换宠物的显示状态。
- 单实例运行：重复启动程序时会唤回已有宠物，不会创建多个实例。
- “每日论文”入口会使用系统默认浏览器打开 [Daily arXiv AI Enhanced](https://akes1a.github.io/daily-arXiv-ai-enhanced/)。
- “流程画板”入口会使用系统默认浏览器打开 [Excalidraw](https://excalidraw.com/)。
- “GPT”入口会使用系统默认浏览器打开 [ChatGPT](https://chatgpt.com/)。
- “DeepSeek”入口会使用系统默认浏览器打开 [DeepSeek](https://chat.deepseek.com/)。
...
| 移动鼠标 | 宠物视线跟随鼠标 |
| 右键宠物 | 打开快捷菜单 |
| 菜单打开时左键点击屏幕其它区域 | 关闭快捷菜单 |

宠物右键菜单提供“每日论文”“待办事项”“流程画板”“GPT”“DeepSeek”“控制面板”和“退出程序”入口。宠物形象及运行选项统一在控制面板中管理。
